  ...
  return (
    <Layout title={TITLE}>
      ...
      <P>
        ...
        The target of text mining is to extract (useful) structured information from unstructured text. In contrast, text generation attempts to (automatically) create text from structured information or distributed knowledge.
